...
from sensor.optimization_stock_weight_v0 import OptimizationStockWeight
from sensor.save_to_npy import SaveToBundleSensor


class flow_optim_v0_forward_return(L1Norm):
    def initialize(self):
    ...
    def _init_optim(self):
        ...
        self._optim_flow.add_next_step2(name="fittedForwardReturnData",
                                        ...
                                        kwds={"factorList": {'fake_forward_return_f1': FACTOR_STYLE.ALPHA}}
                                        )
        ...
        self._optim_flow.add_next_step(sensor=OptimizationStockWeight,
